              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={fadeInLeft}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-8 md:p-10 border border-white/10 bg-white/[0.02] hover:border-white/30 transition-all duration-500 shadow-sm hover:shadow-md relative overflow-hidden group flex flex-col justify-between">
                    ...
                    <button className="w-full bg-transparent border border-white/20 text-white py-4 rounded-full font-medium text-[13px] tracking-wide hover:bg-white hover:text-black transition-colors flex items-center justify-center gap-2 group-hover:border-black">
        ...
        <section className="w-full py-[100px] bg-[#0a0a0a] relative overflow-hidden">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={flyInZoom} className="max-w-[800px] mx-auto px-6 relative z-10 text-center">
            <div className="flex justify-center mb-6">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-bold tracking-[0.2em] uppercase shadow-[0_0_15px_rgba(52,211,153,0.15)]">
